...
export const queryWorkerAIStructured = async (ai: AiBinding, prompt: string, schema: object, systemPrompt?: string) => {
  return generateStructured(ai, prompt, schema, { structuringInstruction: systemPrompt });
}