/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bdd13953fd35ad98392142e55d0dfe9d)
// Runtime types generated with workerd@1.20251202.0 2024-11-11 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./backend/index");
		durableNamespaces: "JulesSupervisor";
	}
	interface Env {
		AGENT_MEMORY: KVNamespace;
		MCP_API_URL: "https://docs.mcp.cloudflare.com/mcp";
		WORKER_URL: "https://core-jules-api.hacolby.workers.dev";
		...
		JulesSupervisor: DurableObjectNamespace<import("./backend/index").JulesSupervisor>;
		DB: D1Database;
